#
#  Be sure to run `pod spec lint JLDualCircularProgressView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://github.com/JJLewis/JLDualCircularProgressView"
  ...
  s.source_files  = "JLDualCircularProgressView"
